...
BOOST_AUTO_TEST_CASE(interpolation_gradient_integration_test_odd) {
  ...
  BOOST_CHECK_SMALL(Utils::norm(interpolated_value - exact_value), 1.e-4);
}
...
BOOST_AUTO_TEST_CASE(interpolation_gradient_vec_integration_test_odd) {
  ...
  BOOST_CHECK_SMALL(Utils::norm(interpolated_value[0] - exact_value[0]), 1.e-2);
  BOOST_CHECK_SMALL(Utils::norm(interpolated_value[1] - exact_value[1]), 1.e-4);
}
