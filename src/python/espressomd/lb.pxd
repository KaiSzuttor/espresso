...
##############################################
        ...
        int lb_lbnode_get_pi(const Vector3dint& ind, double * double_return)
        int lb_lbnode_get_pi_neq(const Vector3dint& ind, double * double_return)
        int lb_lbnode_get_pop(const Vector3dint& ind, double * double_return)
        int lb_lbnode_set_pop(const Vector3dint& ind, double * double_return)
        int lb_lbnode_get_boundary(const Vector3dint& ind, int * int_return)
