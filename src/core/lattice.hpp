...
public:
  ...
  Vector<3, int> grid; /** number of local lattice sites in each direction
                  (excluding halo) */
  Vector<3, int> global_grid;
  ...
  Vector<3, int> local_index_offset;
   ...
   */
  static void map_position_to_lattice_global(Vector3d &pos, Vector<3, int> &ind,
