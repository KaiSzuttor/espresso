...
void cluster_neighbors(int point, const Vector<3, int> &dim, int neighbors[6]) {
  int x, y, z, a;
...
/** hole cluster algorithm.
   ...
   them */
int cluster_free_volume_grid(IntList mesh, const Vector<3, int> &dim,
                             int ***holes) {
  int i = 0, j, k, n = -1, li;
  int neighbors[6];
...
void cluster_free_volume_surface(IntList mesh, const Vector<3, int> &dim,
