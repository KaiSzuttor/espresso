...
BOOST_AUTO_TEST_CASE(algebraic_operators) {
  Vector3dInt v1{1, 2, 3};
  Vector3dInt v2{4, 5, 6};

  BOOST_CHECK((v1 * v2) ==
              std::inner_product(v1.begin(), v1.end(), v2.begin(), 0));

  BOOST_CHECK(((v1 + v2) == Vector3dInt{5, 7, 9}));
  BOOST_CHECK(((v1 - v2) == Vector3dInt{-3, -3, -3}));
  BOOST_CHECK(((-v1) == Vector3dInt{-1, -2, -3}));
  ...
  BOOST_CHECK(((2 * v1) == Vector3dInt{2, 4, 6}));
  BOOST_CHECK(((v1 * 2) == Vector3dInt{2, 4, 6}));

  {
    Vector3dInt v1{2, 4, 6};
    auto v2 = 2 * v1;
    BOOST_CHECK(v2 == (v1 *= 2));
  }
...
BOOST_AUTO_TEST_CASE(swap) {
  const auto cv1 = Vector3dInt{1, 2, 3};
  const auto cv2 = Vector3dInt{4, 5, 6};
